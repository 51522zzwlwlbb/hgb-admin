<template>
  <div>
    ...
    <n-card :bordered="false" title="基本信息" class="mt-4 proCard" size="small" :segmented="{ content: true }">
      <n-descriptions label-placement="left" class="py-2">
        <n-descriptions-item>
          <template #label>收款人姓名</template>
          啊俊
        </n-descriptions-item>
        <n-descriptions-item label="收款账户">hgbAdmin@qq.com</n-descriptions-item>
        <n-descriptions-item label="付款类型">支付宝</n-descriptions-item>
        <n-descriptions-item label="付款账户">hgbAdmin@163.com</n-descriptions-item>
    ...
    <n-card :bordered="false" title="其它信息" class="mt-4 proCard" size="small" :segmented="{ content: true }">
      <n-descriptions label-placement="left" class="py-2">
        <n-descriptions-item>
        ...
        <n-descriptions-item label="邮箱">hgbAdmin@qq.com</n-descriptions-item>
    ...
    <n-card :bordered="false" title="表格信息" class="mt-4 proCard" size="small" :segmented="{ content: true }">
