  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      const getChangeStyle = computed(() => {
        ...
        let lenNum = navMode.value === 'horizontal' || !isMixMenuNoneSub.value ? '0px' : collapsed ? `${minMenuWidth}px` : `${menuWidth}px`;
      ...
      function onScroll(e) {
        ...
        state.isMultiHeaderFixed = !!(!headerSetting.value.fixed && multiTabsSetting.value.fixed && scrollTop >= 64);
      }
